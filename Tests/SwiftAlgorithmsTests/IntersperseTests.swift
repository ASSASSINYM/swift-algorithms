...
final class IntersperseTests: XCTestCase {
  ...
  func testIndexTraversals() {
    ...
    validator.test("".interspersed(with: "-"), expectedCount: 0)
    validator.test("A".interspersed(with: "-"), expectedCount: 1)
    validator.test("AB".interspersed(with: "-"), expectedCount: 3)
    validator.test("ABCDE".interspersed(with: "-"), expectedCount: 9)
  }
