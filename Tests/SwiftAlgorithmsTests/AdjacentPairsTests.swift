...
final class AdjacentPairsTests: XCTestCase {
  ...
  func testIndexTraversals() {
    ...
    validator.test((0..<0).adjacentPairs(), expectedCount: 0)
    validator.test((0..<1).adjacentPairs(), expectedCount: 0)
    validator.test((0..<2).adjacentPairs(), expectedCount: 1)
    validator.test((0..<5).adjacentPairs(), expectedCount: 4)
  }
